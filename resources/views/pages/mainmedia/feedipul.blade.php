        ...
        <div class="box-body">
            <div class="box-body table-responsive no-padding">
                <table class="table table-hover">
                    ...
                    <tr>
                        <td><span style="font-size:12px;">{{ \App\Http\Controllers\MainmediaController::getMedia($ipul['link']['@attributes']['href']) }}</span></td>
                        <td><a style="font-size:14px;" href={{ $ipul['link']['@attributes']['href'] }} target="_blank">{!! $ipul['title'] !!}</a></td>

...
//make the markers toggleable
    ...
    "type": "serial",
            ...
            "color" : "#1FBED6",
                    "Cagub": "Khofifah",
                    "Jumlah": {{ \App\Http\Controllers\CumulativeController::getAllToday(1)}}
            }, {
            "color" : "blue",
                    "Cagub": "Emil",
                    "Jumlah": {{ \App\Http\Controllers\CumulativeController::getAllToday(3)}}
            }, {
            "color" : "red",
                    "Cagub": "Gus Ipul",
                    "Jumlah": {{ \App\Http\Controllers\CumulativeController::getAllToday(2)}}
            }, {
            "color" : "pink",
                    "Cagub": "Puti",
                    "Jumlah": {{ \App\Http\Controllers\CumulativeController::getAllToday(4)}}
            }],
            "valueAxes": [ {
            "minimum": 0,
                    "gridColor": "#FFFFFF",

  ...
  chart.legend.addListener("clickMarker", handleCustomMarkerToggle);
		...
		var chart = AmCharts.makeChart( "chartdivtoday", {
		  ...
		  "dataProvider": [ {
			"color" : "#1FBED6",  
			"Cagub": "Khofifah",
			"Jumlah": {{ \App\Http\Controllers\GplusController::getToday(1)}}
		  }, {
			"color" : "blue",
			"Cagub": "Emil",
			"Jumlah": {{ \App\Http\Controllers\GplusController::getToday(3)}}
		  }, {
			"color" : "red",
			"Cagub": "Gus Ipul",
			"Jumlah": {{ \App\Http\Controllers\GplusController::getToday(2)}}
		  }, {
			"color" : "pink",
			"Cagub": "Puti",
			"Jumlah": {{ \App\Http\Controllers\GplusController::getToday(4)}}
		  }],
		  "valueAxes": [ {
			"minimum": 0,
			"gridColor": "#FFFFFF",

<!-- Chart code -->
<script>
    var khofToday = {{ \App\Http\Controllers\TwitterController::getToday(1)}};
    var emilToday = {{ \App\Http\Controllers\TwitterController::getToday(2)}};
    var ipulToday = {{ \App\Http\Controllers\TwitterController::getToday(3)}};
    var putiToday = {{ \App\Http\Controllers\TwitterController::getToday(4)}};
</script>
